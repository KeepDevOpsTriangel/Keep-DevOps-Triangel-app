...
class ConfigApp():
    ...
    TITULO_APP = os.getenv('TITULO_APP', 'TITULO_APP') + '\n\n'
    TELEFONO_SOPORTE = os.getenv(
        'TELEFONO_SOPORTE', '000000000') + '\n\n'
    CHAT_ID_SOPORTE = os.getenv(
        'CHAT_ID_SOPORTE', '000000') + '\n\n'
    EMAIL_SOPORTE = os.getenv('EMAIL_SOPORTE', 'EMAIL_SOPORTE') + '\n\n'
    ...
    WEB_USERNAME = os.getenv('WEB_USERNAME', 'web')
    WEB_PASSWORD = os.getenv('WEB_PASSWORD', 'web')
    REDIS_HOST = os.getenv('REDIS_HOST', 'localhost')
    MONGO_HOST = os.getenv('MONGO_HOST', 'localhost')
    MONGO_PORT = os.getenv('MONGO_PORT', 27017)
    MONGO_DATABASE = os.getenv('MONGO_DATABASE', 'mongo')
    MONGO_COLLECTION = os.getenv('MONGO_COLLECTION', 'mongo')
